...
public:	
	...
	int FindSpecificItemIndex(AActor* obj); /** Finds the index of a given object (if existing in the inventory) */

	UFUNCTION(BlueprintCallable, Category = "Utility")
	AActor* FindSpecificItem(AActor* obj); /** Finds the index of a given object (if existing in the inventory) */
