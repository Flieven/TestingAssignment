...
int UUInventoryComponent::FindSpecificItemIndex(AActor* obj)
{
	return Inventory.Find(obj);
}

AActor* UUInventoryComponent::FindSpecificItem(AActor* obj)
{
	if(Inventory.Find(obj) != INDEX_NONE)
	{
		return Inventory[Inventory.Find(obj)];
	}
	else { return nullptr; }
}
